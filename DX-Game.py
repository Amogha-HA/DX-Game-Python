...
level = int(input("Enter the level you want to play? 1/2/3/4/5"))
length = 500/level


root = Tk()
root.title("Amogha's Game")
root.resizable(0,0)
...
score_now = canvas.create_text(430, 20, text="score: " + str(count), fill = "green", font=("Arial", 16))
